...
## Description
Full-stack wedding package booking platform built with Laravel, Next.js, and REST API integration. Features modern UI, package management, booking system, and admin dashboard.
